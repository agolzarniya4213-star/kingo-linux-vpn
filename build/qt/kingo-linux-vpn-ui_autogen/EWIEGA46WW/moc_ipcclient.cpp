...
void IpcClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (IpcClient::*)(const QJsonObject & )>(_a, &IpcClient::responseReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (IpcClient::*)(const QString & )>(_a, &IpcClient::errorOccurred, 1))
            return;
    }
}
...
// SIGNAL 0
void IpcClient::responseReceived(const QJsonObject & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void IpcClient::errorOccurred(const QString & _t1)
{
