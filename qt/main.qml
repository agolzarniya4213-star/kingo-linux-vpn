...
ApplicationWindow {
    ...
    Menu {
        ...
        MenuItem {
            text: "Add Server"
            onTriggered: addServerDialog.open()
        }
        MenuItem {
            text: "Fetch Servers"
            onTriggered: vpnController.addSubscription("https://raw.githubusercontent.com/MhdiTaheri/VpnHub/main/sub")
        }
        MenuItem {
            text: "Test All Ping"
            onTriggered: vpnController.testLatency()
        }
    }
